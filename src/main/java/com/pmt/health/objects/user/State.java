...
public enum State implements UserValue {
    ...
    DISTRICT_OF_COLUMBIA("District of Columbia", "DC", new Address("1600 Pennsylvania Ave NW", "Washington", "20500"), "202",
            false), FEDERATED_STATES_OF_MICRONESIA("Federated States of Micronesia", "FM", new Address(), "999", false),
    ...
    MONTANA("Montana", "MT", new Address("751 W Grant St", "Bozeman", "59715"), "406", false),

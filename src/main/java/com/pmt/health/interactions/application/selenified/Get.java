...
public class Get {
    ...
    /**
     * Retrieves the content of an alert present on the page. If the alert doesn't
    ...
    /**
     * Retrieves the full cookie in the application with the provided cookieName. If
     * the cookie doesn't exist, a null value will be returned.
     *
     * @param expectedCookieName - the name of the cookie
     * @return Cookie - the cookie
     */
    private Cookie cookie(String expectedCookieName) {
        try {
    ...
    /**
     * Retrieves the cookie domain in the application with the provided cookieName.
    ...
    /**
     * Retrieves the cookie path in the application with the provided cookieName. If
     * the cookie doesn't exist, a null value will be returned.
     *
     * @param expectedCookieName - the name of the cookie
    ...
    /**
     * Retrieves the cookie value in the application with the provided cookieName.
     * If the cookie doesn't exist, a null value will be returned.
     *
     * @param expectedCookieName - the name of the cookie
    ...
    /**
     * Executes a provided script, and returns the output of that script. If there
     * is an error executing this script, a null value will be returned.
     *
    ...
    /**
     * Retrieves the content of a prompt present on the page. If the prompt doesn't
     * exist, a null value will be returned.
     *

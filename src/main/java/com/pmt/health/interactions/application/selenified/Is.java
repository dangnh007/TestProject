...
public class Is {
    ...
    /**
     * Determines if a prompt is present on the page. This information will not be
     * logged or recorded.
     *
    ...
    public boolean textPresent(String expectedText) {
        try {
            String bodyText = App.getSanitizedString(driver.findElement(By.tagName("body")).getText());
            return bodyText.contains(App.getSanitizedString(expectedText));
        } catch (Exception e) {
            log.info(e);
            return false;
        }
    ...
    public boolean textPresentInSource(String expectedText) {
        try {
            return App.getSanitizedString(driver.getPageSource()).contains(App.getSanitizedString(expectedText));
        } catch (Exception e) {
            log.info(e);
            return false;
        }

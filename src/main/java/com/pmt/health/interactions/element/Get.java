...
public class Get {
    ...
    /**
     * Retrieves all attributes of the element. If the element isn't present, or the
     * attributes can't be accessed, a null value will be returned.
     *
     ...
     * present, the attribute doesn't exist, or the attributes can't be accessed, a
     ...
     */
    private Object eval(String javascriptFunction) {
        if (!element.is().present()) {
            return null;
        }
        try {
    ...
    /**
     * Retrieves the number of select options in the element. If the element isn't
     * present or a select, the returned response will be zero.
     *
     * @return Integer: how many select options are available in the select element
     */
    ...
    /**
     * Retrieves the number of columns in the element. If the element isn't present
    ...
    /**
     * Retrieves the number of rows in the element. If the element isn't present or
     * a table, the returned response will be zero
     *
    ...
    /**
     * Retrieves the selected option for the element. If the element isn't present
    ...
    /**
     * Retrieves the selected options for the element. If the element isn't present
     * or a select, a null value will be returned.
     *
    ...
    public String[] selectedOptions() {
        ...
        String[] stringOptions = new String[size];
    ...
    /**
     * Retrieves the selected value for the element. If the element isn't present or
     * a select, a null value will be returned.
     *
     * @return String: the options from the select element
     */
    ...
    /**
     * Retrieves the selected values for the element. If the element isn't present
     * or a select, a null value will be returned.
     *
     * @return String[]: the options from the select element
     */
    ...
    /**
     * Retrieves the select options in the element. If the element isn't present or
     * a select, a null value will be returned.
     *
     * @return String[]: the options from the select element
     */
    public String[] selectOptions() {
        ...
        String[] stringOptions = new String[size];
        for (int i = 0; i < size; i++) {
            stringOptions[i] = App.getSanitizedString(options.get(i).getText());
        }
        return stringOptions;
    }
    ...
    /**
     * Retrieves a specific cell from the element. If the element isn't present or a
     * table, or the row and cell combination doesn't exist, a null value will be
     * returned.
     *
     * @param rowNum - the number of the row in the table - note, row numbering starts
     *               at 1, NOT 0
     * @param colNum - the number of the column in the table - note, column numbering
     *               starts at 1, NOT 0
     * @return WebElement: the cell element object, and all associated values with
     * it
     */
    ...
    /**
     * Retrieves a specific column from the element. If the element isn't present or
     * a table, a null value will be returned. If the specified row is out of range,
     ...
     */
    private List<List<WebElement>> tableColumns() {
        if (!element.is().present()) {
            return null; // NOSONAR - returning an empty array could be confused
            // with no rows
        }
    ...
    /**
     * Retrieves a specific row from the element. If the element isn't present or a
     * table, a null value will be returned. If the specified row is out of range,
     * an empty list is returned
     *
     ...
     */
    private List<WebElement> tableRow(int rowNum) {
        List<WebElement> rows = tableRows();
        if (rows == null) {
            return null; // NOSONAR - returning an empty array could be confused
    ...
    /**
     * Retrieves the rows in the element. If the element isn't present or a table, a
     * null value will be returned.
     *
    ...
    /**
     * Retrieves the text of the element. If the element isn't present, a null value
     * will be returned.
     *
    ...
    public String text() {
        ...
        WebElement webElement = element.getWebElement();
        return App.getSanitizedString(webElement.getText());
    }

    /**
     * Retrieves the value of the element. If the element isn't present, or isn't an
     * input, a null value will be returned.
     *
    ...
    /**
     * Retrieves the xpath associated with the particular element. If the element

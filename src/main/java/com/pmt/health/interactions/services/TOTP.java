...
public class TOTP {
    ...
    public static final String OUTLINE_BAR = "+---------------+-----------------------+------------------+--------+--------+";
    ...
    public static void main(String[] args) {
        ...
        String seed64 = "31323334353637383930313233343536373839303132333435363738393031323334353637383930" +
        ...
        String padzeroes = "0000000000000000"; // 16 zeros.
        String steps = "0";
        DateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        df.setTimeZone(TimeZone.getTimeZone("UTC"));

        try {
            System.out.println(OUTLINE_BAR);
            System.out.println("|  Time(sec)    |   Time (UTC format)   | Value of T(Hex)  |  TOTP  | Mode   |");
            System.out.println(OUTLINE_BAR);

            for (int i = 0; i < testTime.length; i++) {
                long tTime = (testTime[i] - T0) / X;
                steps = Long.toHexString(tTime).toUpperCase();
                steps = padzeroes.substring(0, 15 - steps.length());
                String fmtTime = String.format("%1$-11s", testTime[i]);
                String utcTime = df.format(new Date(testTime[i] * 1000));
                System.out.print("|  " + fmtTime + SPACER + utcTime + SPACER + steps + " |");
